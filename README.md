...
- Configure your scale with Zepp Life App on your mobile device (tested on Android 10 and 11);
- Retrieve scale's MAC Address from Zepp Life App (go to Profile > My devices > Mi Body Composition Scale 2):
...
```
wget https://github.com/RobertWojtowicz/miscale2garmin/archive/refs/tags/3.1.tar.gz -O - | tar -xz
cd miscale2garmin-3.1
...
```
$ python3 /home/robert/miscale2garmin-3.1/scanner_ble.py
...
```
$ /home/robert/miscale2garmin-3.1/import_ble.sh
Mi Body Composition Scale 2 Garmin Connect v3.1 (import_ble.sh)
...
```
$ cat /home/robert/miscale2garmin-3.1/temp.log
... uploading weight
...
```
*/1 * * * * /home/robert/miscale2garmin-3.1/import_ble.sh
```
...
```
$ /home/robert/miscale2garmin-3.1/import_mqtt.sh
Mi Body Composition Scale 2 Garmin Connect v3.1 (import_mqtt.sh)
...
```
*/1 * * * * /home/robert/miscale2garmin-3.1/import_mqtt.sh
```
